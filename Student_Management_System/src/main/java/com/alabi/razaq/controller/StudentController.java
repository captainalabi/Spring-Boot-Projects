package com.alabi.razaq.controller;
...
import com.alabi.razaq.service.StudentService;
...
public class StudentController {
	...
	//handler method to handle list of all students request and return model and view
	@GetMapping("/students")
